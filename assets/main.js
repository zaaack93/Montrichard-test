...
var SwiperComponent = /*#__PURE__*/function (_HTMLElement) {
  _inherits(SwiperComponent, _HTMLElement);
  ...
  _createClass(SwiperComponent, [{
    ...
    key: "adjustSectionWidth",
    value: function adjustSectionWidth() {
      var section = this.section; // Adjust selector as needed
      var progressBar = this.querySelector('.swiper-scrollbar'); // Select the progress bar element within the custom element
      var windowWidth = window.innerWidth;
      if (windowWidth > 1640) {
        var spaceRemaining = windowWidth - 1640;
        var marginLeft = spaceRemaining / 2;
        section.style.maxWidth = "".concat(1640 + marginLeft, "px");
        section.style.marginLeft = "".concat(marginLeft, "px");
